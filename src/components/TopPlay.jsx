...
// Define TopChartCard as a functional component directly in TopPlay.jsx
const TopChartCard = ({ song, i, isPlaying, activeSongs, handlePauseClick, handlePlayClick }) => {
  return (
          ...
          {topPlays?.map((song, i) => (
            ...
            >
              <Link to={`/artist/${song?.artists[0]?.adamid}`}>
                {song && song.images && song.images.background && (
